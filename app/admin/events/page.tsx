...
export default function AdminEventsPage() {
  ...
  const [form, setForm] = useState<EventItem>(defaultForm)

  const openNew = () => {
    setForm({ ...defaultForm, id: Date.now() })
    setEditing(null)
    setShowForm(true)
  }
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                value={form.status}
                onChange={(e) =>
                  setForm({ ...form, status: e.target.value as 'upcoming' | 'past' })
                }
